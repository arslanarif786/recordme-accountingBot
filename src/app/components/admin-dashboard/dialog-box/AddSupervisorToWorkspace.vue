  ...
  <div class="text-center">
    <v-dialog v-model="dialog" width="450" persistent>
      <v-card>
        ...
        <v-card-text>
          Note : Supervisor will be added to the respected workspace
        </v-card-text>
...
export default {
  ...
  mounted() {
    ...
    EventBus.$on("add-supervisor-to-workspace", (object) => {
  ...
  methods: {
    ...
    closeDialog() {
      (this.dialog = false), (this.selected = "");
    },
  },
};
</script>
