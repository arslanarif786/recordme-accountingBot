...
export default {
      ...
      this.$store
        ...
        .then((response) => {
          EventBus.$emit("show-snackbar", {
            text: " Supervisor has been created",
            type: "success",
          });
          this.dialog = false;
  ...
  mounted() {
    EventBus.$on("open-supervisor-dialog", (workspaces) => {
      this.dialog = true;
      this.workspaces = workspaces;
    });
  },
  beforeUnmount() {
    EventBus.$off("open-supervisor-dialog");
  },
};
</script>
