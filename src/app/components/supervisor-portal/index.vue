...
import Loader from "../accountant-portal/loader/index.vue";
import TicketComponent from "../accountant-portal/ticket-component/index.vue";
import NewTicketNotification from "../accountant-portal/new-ticket-notification/index.vue";
...
import RerouteTicketSupervisorDialog from "../dashboard/dialog-box/RerouteTicketSupervisorDialog.vue";
...
export default {
  ...
  data: () => ({
    ...
    xeroSubmission: false,
  }),
  /**
   * Provide xeroSubmission(bool variable) to XeroForm grand-parent Component
   */
  // provide() {
  //   return {
  //     xeroSubmission: computed(() => this.xeroSubmission),
  //   }
  // },
  watch: {},
  computed: {
  ...
  methods: {
    ...
    */
    ...
    emitTicketSocket() {
      socket.emit("findSupervisorTicket", this.user._id);
    },
    ...
    socketForChangeStatus(status) {
      socket.emit("changeSupervisorTicketStatus", {
    ...
    async APIcalling() {
      ...
      if (response.data && response.data.ticket) {
        ...
        this.xeroSubmission = response.data.ticket.xeroSubmission;
